...
import {canvasPresenceRoutes} from './routes/canvas-presence.js';
import {documentCollabRoutes} from './routes/document-collab.js';
...
app.route('/api', canvasPresenceRoutes);
