...
/**
 * cos theme — built by `pnpm exec astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { cosTheme } from './cos';
 *   import './cos.css';
 */
export const cosTheme = {
  name: 'cos',
  __built: true,
  tokens: {
    ...
    "--font-family-body": "var(--font-dm-sans), -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, sans-serif",
    "--font-family-heading": "var(--font-dm-sans), -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, sans-serif",
    ...
    "--color-background-body": "light-dark(#F4F6FA, #0E1116)",
    ...
    "--color-accent": "light-dark(#2B5DAB, #B3C5FF)",
    ...
    "--color-text-secondary": "light-dark(#434653, #A8ABB9)",
    "--color-text-disabled": "light-dark(#8D909E, #5B5E6B)",
    "--color-text-accent": "var(--color-accent)",
    "--color-on-dark": "#ffffff",
    "--color-on-light": "#171717",
    "--color-on-accent": "light-dark(#FFFFFF, #003076)",
    ...
    "--color-icon-secondary": "light-dark(#434653, #A8ABB9)",
    "--color-icon-disabled": "light-dark(#8D909E, #5B5E6B)",
    "--color-success": "light-dark(#007004, #9fe59b)",
    "--color-error": "light-dark(#a50c25, #ffc6c1)",
    "--color-warning": "light-dark(#B7791F, #E8B341)",
    ...
    "--color-border-emphasized": "light-dark(#8D909E, #656875)",
    "--color-skeleton": "light-dark(#A8ABB9, #434653)",
    ...
    "--color-track": "light-dark(#A8ABB9, #434653)",
    "--radius-chat": "35px"
  },
